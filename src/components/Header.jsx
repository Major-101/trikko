...
export default function Header() {
  ...
  return (
    <header className='fixed z-50 top-0 left-0 text-secondary w-full bg-transparent-4 backdrop-blur-sm'>
      <div className="container mx-auto flex justify-between p-4 gap-4 items-center">
        ...
        <LuText />
        <h1 className='text-xl md:text-2xl font-semibold'>Ibrahim Major</h1>
        </Link>
        <div className="flex w-max gap-2 items-center">
          ...
          <Link to={"/account"} className="h-8 w-8 text-secondary hover:text-dark cursor-pointer flex justify-center items-center"><FaRegUser />
          </Link>
          <Link to={"/cart"} className="h-8 w-8 text-secondary hover:text-dark cursor-pointer flex justify-center items-center text-large relative">
